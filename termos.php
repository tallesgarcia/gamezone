...
<head>
    ...
    <title>Termos de Uso - GameZone</title>
...
<header class="bg-indigo-700 p-6 shadow-md mt-16">
  <div class="container mx-auto">
    <h1 class="text-3xl font-bold">Termos de Uso</h1>
  </div>
</header>

<main class="flex-grow container mx-auto p-6 max-w-4xl">
  <section class="space-y-6">
    <p>Bem-vindo ao GameZone. Ao acessar e usar nosso site, você concorda em cumprir e estar vinculado aos seguintes termos e condições de uso.</p>

    <h2 class="text-xl font-semibold">1. Uso do Site</h2>
    <p>Você concorda em utilizar o site apenas para fins legais e de acordo com todas as leis aplicáveis. É proibido usar o site para atividades ilegais ou prejudiciais.</p>

    <h2 class="text-xl font-semibold">2. Propriedade Intelectual</h2>
    <p>Todo conteúdo do GameZone, incluindo textos, imagens, logos e softwares, são protegidos por direitos autorais e não podem ser usados sem autorização prévia.</p>

    <h2 class="text-xl font-semibold">3. Responsabilidades do Usuário</h2>
    ...
    <h2 class="text-xl font-semibold">4. Limitação de Responsabilidade</h2>
    <p>O GameZone não se responsabiliza por danos diretos ou indiretos decorrentes do uso do site ou de seus serviços.</p>

    <h2 class="text-xl font-semibold">5. Alterações nos Termos</h2>
    <p>Reservamo-nos o direito de modificar estes termos a qualquer momento, sendo recomendada a revisão periódica pelo usuário.</p>

    <h2 class="text-xl font-semibold">6. Contato</h2>
    <p>Em caso de dúvidas sobre estes termos, entre em contato conosco pelo e-mail contato@gamezone.com.br.</p>
  </section>
</main>
